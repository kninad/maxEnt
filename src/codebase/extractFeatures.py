...
class ExtractFeatures(object):
    ...
    def __init__(self, dataArray, entropy_estimator='JAMES-STEIN', topK=5):
        ...
        # Dict to store the L-measure values for all the pairs
        # Will be assinged once the appropriate method is run
        self.L_measure_dict = {}  

        # For the exact feature value pairs in the Constraints  
        self.feats_pairs_dict = {}
        
        # Graph (dict in python) to store the feature partition graph
        # Its an adjacency list representation
        self.feat_graph = {}     
        
        # Data structure to store the indices of the feature partitions
        # from amongst the total set of features. 
    ...
    # Function to compute the normalized L-measure between the all 
    # feature pairs
    ...
    # Function to compute the top-K feature pairs and their 
    # corresponding values from amongst all the pairs.
